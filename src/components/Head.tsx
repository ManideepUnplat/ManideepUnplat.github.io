...
function Head(props: any) {
  ...
  return (
    <div>
      ...
      {
        isOpen && 
        <div className='w-[170px] p-2 fixed top-9 right-2 bg-white border-2 rounded-lg'>
          <a href='https://timedotdevdevelopmentstudent.web.app/home' target="_blank" className='flex h-[50px] items-center'>
            <svg width="10" height="18" viewBox="0 0 10 18" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M0 0.666672V5.66667L3.33333 9L0 12.3333V17.3333H10V12.3333L6.66667 9L10 5.66667V0.666672H0Z" fill="#7B7D85"/>
            </svg>
          ...
          
          {
            ...
            <>
              <hr/>
              <hr/>
              <div className='flex h-[50px] items-center' onClick={()=>{
